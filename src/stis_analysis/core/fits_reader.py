...
LA-Cosmic 処理後（_lac.fits）には追加で以下の HDU が含まれる:

- HDU 4: ImageHDU（LA-Cosmic マスク, EXTNAME='LACOSMIC'）

open() は全 HDU を動的に走査するため、HDU 数に関わらず正しく読み込める。
"""
